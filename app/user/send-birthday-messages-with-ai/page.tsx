...
export default function SendBirthdayMessagesWithAiPage() {
    ...
    const fetchMessages = async () => {
        const res = await fetchApi(`/api/whatsapp/message-list-ai?search=${search}&page=${page}&limit=${limit}&status=${status}`, {
            method: "GET",
    ...
    return (
            <div className="w-full p-6 bg-white rounded-lg shadow-md">
                <h1 className="text-xl font-bold mb-4">Send Birthday Messages</h1>
                <div className="mb-4">
                    <button
                ...
                <AiMessageModal open={modal} onClose={() => setModalOpen(false)}></AiMessageModal>
